...
public class CustomAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
        ...
        public TextViewHolder(@NonNull View itemView) {
            ...
            itemView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    Toast.makeText(mContext, mObjects.get(getBindingAdapterPosition()).toString(), Toast.LENGTH_SHORT).show();
                }
            });
        }
    }
    ...
    public class ImageViewHolder extends RecyclerView.ViewHolder {
        ...
        public ImageViewHolder(@NonNull View itemView) {
            super(itemView);
            imvImage = itemView.findViewById(R.id.inv_image);

            itemView.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View view) {
                    Toast.makeText(mContext, "Image Resource ID: " + mObjects.get(getAdapterPosition()), Toast.LENGTH_SHORT).show();
                }
            });
        }
    }
    ...
    public class UserViewHolder extends RecyclerView.ViewHolder {
        ...
        public UserViewHolder(@NonNull View itemView) {
            ...
            itemView.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View view) {
                    UserModel user = (UserModel) mObjects.get(getBindingAdapterPosition());
