...
public class ExListViewActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                Toast.makeText(ExListViewActivity.this, "Click vào vị trí: " + i, Toast.LENGTH_SHORT).show();
        ...
        listView.setOnItemLongClickListener(new AdapterView.OnItemLongClickListener() {
            ...
            public boolean onItemLongClick(AdapterView<?> adapterView, View view, int i, long l) {
                Toast.makeText(ExListViewActivity.this, "Đang giữ item: " + arrayList.get(i), Toast.LENGTH_SHORT).show();
                return false;
            }
        });
